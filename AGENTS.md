...
- Use `<your name>__<module name>` for the custom Studio subsystem/module identifier to avoid conflicts. In C identifiers and protobuf package names, use an identifier-safe form like `nano0nfire__active_layer_notify` / `your_name.template`.
