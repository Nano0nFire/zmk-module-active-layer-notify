# Active Layer Notify Module - Web Frontend

This is a minimal web application for interacting with ZMK firmware
...
└── proto/                # Generated protobuf TypeScript types
    └── nano0nfire/active_layer_notify/
        └── active_layer_notify.ts
...
The protobuf schema is defined in `../proto/nano0nfire/active_layer_notify/active_layer_notify.proto`.
...
// Find your subsystem
const subsystem = findSubsystem("nano0nfire__active_layer_notify");
...
const mockZMKApp = createConnectedMockZMKApp({
  ...
  subsystems: ["nano0nfire__active_layer_notify"],
});
...
To adapt this module for your own ZMK module:

1. **Update the proto file**: Modify `../proto/nano0nfire/active_layer_notify/active_layer_notify.proto` with
   your message types
